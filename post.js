...
window.addEventListener("DOMContentLoaded",()=>{
    axios.get("https://crudcrud.com/api/7db2fde6f7c24db595ab882e38ca4c36/Expenses")
         .then((response)=>{
...
function addExpense(e){
    ...
    if(type != 'chooseOne' 
        ...
        axios.post("https://crudcrud.com/api/7db2fde6f7c24db595ab882e38ca4c36/Expenses",expense)
             .then((response)=>{
...
function deleteExpense(expenseId){
    ...
    axios.delete(`https://crudcrud.com/api/7db2fde6f7c24db595ab882e38ca4c36/Expenses/${expenseId}`)
         .then((response)=>{
